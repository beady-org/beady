...
class Shell(Command):
    """Start beady in an interactive shell"""
    ...
    def init(self, args):
        ...
        beady.cli.server.report_configuration()
        beady.service.server.start(preload=[], stop=True)
    ...
    def shell(self, dbname):
        ...
        if dbname:
            ...
            with registry.cursor() as cr:
                ...
                ctx = beady.api.Environment(cr, uid, {})['res.users'].context_get()
                env = beady.api.Environment(cr, uid, ctx)
                local_vars['env'] = env
