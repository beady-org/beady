...
from beady.tools import cloc, config
from . import Command
...
class Cloc(Command):
    ...
    def run(self, args):
        parser = argparse.ArgumentParser(
            ...
            description="""\
Beady cloc is a tool to count the number of relevant lines written in
...
It has two modes of operation, either by providing a path:
    ...
    beady-bin cloc -p module_path

Or by providing the name of a database:

    beady-bin cloc --beads-path=dirs -d database
