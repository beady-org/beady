...
from beady.modules.module import get_module_root, MANIFEST_NAMES
from beady.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """ Quickly start the beady server with default options """
    ...
    def run(self, cmdargs):
        ...
        if mods and '--beads-path' not in cmdargs:
            cmdargs.append('--beads-path=%s' % project_path)
        ...
        try:
            ...
            beady.tools.config['init']['base'] = True
