...
"""The Beady API module defines Beady Environments and method decorators.
...
from beady.tools.misc import StackMap

import typing
if typing.TYPE_CHECKING:
    from collections.abc import Callable
    from beady.sql_db import BaseCursor
    from beady.models import BaseModel
    try:
...
def constrains(*args: str) -> Callable[[T], T]:
    ...
    Should raise :exc:`~beady.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~beady.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/beady/beady/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~beady.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~beady.beads.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~beady.beads.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~beady.beads.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry):
        ...
        # temporary directories (managed in beady.tools.file_open_temporary_directory)
