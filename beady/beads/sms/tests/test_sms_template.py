...
from beady.tests.common import TransactionCase, users
...
from beady.tools import mute_logger, convert_file
...
class TestSmsTemplateAccessRights(TransactionCase):
    ...
    @users('user_system')
    @mute_logger('beady.models.unlink', 'beady.beads.base.models.ir_model')
...
class TestSMSTemplateReset(TransactionCase):
    ...
    def test_sms_template_reset(self):
        ...
        self.assertEqual(sms_template.body.strip(), Markup('<div>Hello Beady</div>'))
