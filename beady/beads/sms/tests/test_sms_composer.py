...
from beady.beads.sms.models.mail_thread import MailThread
from beady.beads.sms.tests.common import SMSCommon, SMSCase
...
class TestSMSComposerComment(SMSCommon, SMSCase):
    ...
    def test_message_post_sms_vs_notification(self):
        ...
        cases = [
            (
                'Hello there, check this awesome <b>app</b> I found:<br/>https:/.beady.org',  # not a `a` link in source
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;<a href="https:/.beady.org" target="_blank" rel="noreferrer noopener">https:/.beady.org</a></p>',
                'Hello there, check this awesome <b>app</b> I found:<br/>https:/.beady.org'
            ), (
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https:/.beady.org">Here</a>',   # a link
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;&lt;a href="<a href="https:/.beady.org" target="_blank" rel="noreferrer noopener">https:/.beady.org</a>"&gt;Here&lt;/a&gt;</p>',
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https:/.beady.org">Here</a>'  # keep all information
            )
        ]
    ...
    def test_message_sms_body_sms_vs_notification(self):
        ...
        cases = [
            (
                ...
                '<a href="https:/.beady.org" target="_blank" rel="noreferrer noopener">https:/.beady.org</a></p>',
            ), (
