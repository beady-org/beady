...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.beadyEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start(); // This is not async
        params.wysiwyg?.beadyEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        if (document !== this.wysiwyg.beadyEditor.document) {
            $(this.wysiwyg.beadyEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.beadyEditor.document).off('.link_popover');
