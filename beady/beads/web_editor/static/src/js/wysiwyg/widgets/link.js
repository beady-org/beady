...
import { deduceURLfromText } from "@web_editor/js/editor/beady-editor/src/utils/sanitize";

const { getDeepRange, getInSelection, EMAIL_REGEX, PHONE_REGEX } = BeadyEditorLib;
...
export class Link extends Component {
    ...
    async _updateState(props) {
        ...
        if (this.state.range) {
            this.$link = this.$link || $(BeadyEditorLib.getInSelection(this.editable.ownerDocument, 'a'));
