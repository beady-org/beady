...
import { BeadyEditor, parseHTML, setSelection, insertCharsAt } from '../../src/BeadyEditor.js';
import {
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        BeadyEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new BeadyEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    BeadyEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
