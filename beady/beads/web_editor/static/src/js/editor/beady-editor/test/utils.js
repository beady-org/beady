...
import { BeadyEditor } from '../src/BeadyEditor.js';
...
export async function testEditor(Editor = BeadyEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteBeadyEditorHtml = async (editor, html) => pasteData(editor, html, 'text/beady-editor');
...
export class BasicEditor extends BeadyEditor {}
