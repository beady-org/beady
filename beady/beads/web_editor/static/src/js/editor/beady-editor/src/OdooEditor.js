...
export class BeadyEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as beady-editor utils to avoid this
        ...
        this.editable.classList.add("beady-editor-editable");
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const beadyHtml = dataHtmlElement.innerHTML.replace(/\uFEFF/g, "");
        const beadyText = selection.toString().replace(/\uFEFF/g, "");
        clipboardEvent.clipboardData.setData('text/plain', beadyText);
        clipboardEvent.clipboardData.setData('text/html', beadyHtml);
        clipboardEvent.clipboardData.setData('text/beady-editor', beadyHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('beady-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const beadyEditorHtml = ev.clipboardData.getData('text/beady-editor');
        ...
        } else if (beadyEditorHtml) {
            const fragment = parseHTML(this.document, beadyEditorHtml);
