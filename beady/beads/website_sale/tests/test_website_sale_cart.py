...
from beady.beads.base.tests.common import BaseUsersCommon
from beady.beads.product.tests.common import ProductAttributesCommon
from beady.beads.website.tools import MockRequest
from beady.beads.website_sale.controllers.combo_configurator import (
    WebsiteSaleComboConfiguratorController,
)
from beady.beads.website_sale.controllers.main import WebsiteSale
from beady.beads.website_sale.controllers.payment import PaymentPortal
from beady.beads.website_sale.models.product_template import ProductTemplate
...
class TestWebsiteSaleCart(BaseUsersCommon, ProductAttributesCommon, WebsiteSaleCommon):
    ...
    def test_checkout_no_delivery_method_available(self):
        ...
        with (MockRequest(self.product.with_user(portal_user).env, website=website), patch(
            'beady.beads.website_sale.models.sale_order.SaleOrder._get_preferred_delivery_method',
