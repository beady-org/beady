...
from beady.beads.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from beady.beads.test_mass_mailing.tests.common import TestMassMailCommon
...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('beady.beads.mass_mailing.models.mailing', 'beady.beads.mail.models.mail_mail', 'beady.beads.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_trace_click(mailing, target_records[0], 'https://www.beady.be')
        self.gateway_mail_trace_click(mailing, target_records[2], 'https://www.beady.be')
        self.gateway_mail_trace_click(mailing, target_records[3], 'https://www.beady.be')
