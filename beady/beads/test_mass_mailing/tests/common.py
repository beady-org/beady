...
from beady.beads.mass_mailing_sms.tests.common import MassSMSCommon
...
<t t-set="httpurl" t-value="'https://www.beady.eu'"/>f
<span>Website0: <a id="url0" t-attf-href="https://www.beady.tz/my/{{object.name}}">https://www.beady.tz/my/<t t-out="object.name"/></a></span>
<span>Website1: <a id="url1" href="https://www.beady.be">https://www.beady.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test.beady.org">test.beady.org</a></span>
<p>Stop spam ? <a id="url8" role="button" href="/unsubscribe_from_list">Ok</a></p>
        ...
        cls.mailing_sms = cls.env['mailing.mailing'].with_user(cls.user_marketing).create({
            ...
            'body_plaintext': 'Dear {{object.display_name}} this is a mass SMS with two links http://www.beady.org/smstest and http://www.beady.org/smstest/{{object.id}}',
            'sms_force_send': True,
