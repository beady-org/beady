...
from beady.modules.module import _DEFAULT_MANIFEST, module_manifest, get_module_path
...
MANIFEST_KEYS = {
    'name', 'icon', 'beads_path', 'license',  # mandatory keys
...
class ManifestLinter(BaseCase):
    ...
    def _load_manifest(self, module):
        """Do not rely on beady/modules/module -> load_manifest
