...
from beady.tools.misc import file_open, mute_logger, file_path
from beady.tools.translate import TranslationModuleReader, TranslationRecordReader, code_translations, CodeTranslations, PYTHON_TRANSLATION_COMMENT, JAVASCRIPT_TRANSLATION_COMMENT, TranslationFileReader
from beady import Command
from beady.beads.base.models.ir_fields import BOOLEAN_TRANSLATIONS
...
class TestImport(common.TransactionCase):
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('beady.beads.base.models.res_lang'):
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_static_templates(self):
        ...
        for line in po_reader:
            ...
            if name == "beads/test_translation_import/static/src/xml/js_templates.xml":
    ...
    def test_export_spreadsheet(self):
        ...
        for line in po_reader:
            ...
            if name == "beads/test_translation_import/data/files/test_spreadsheet_dashboard.json":
                terms.append(source)
    ...
    def test_export_spreadsheet_new_dataset(self):
        ...
        for line in po_reader:
            _module, _ttype, name, _res_id, source, _value, _comments = line
            if name == 'beads/test_translation_import/data/files/test_spreadsheet_v16_dashboard.json':
                terms.append(source)
        self.assertEqual(set(terms), {
            'Bar chart title',
            ...
            'Scorecard title',
            'Opportunities',
            'Beady Chart horizontal axis title',
            'Beady Chart vertical axis title'
        })
