...
from beady.beads.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from beady.beads.mail.tests.common import MailCase, mail_new_test_user
...
from beady.fields import Datetime
from beady import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('beady.beads.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
