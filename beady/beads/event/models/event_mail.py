...
from beady.tools import exception_to_unicode
from beady.tools.translate import _
from beady.exceptions import MissingError
...
class EventMailScheduler(models.Model):
    ...
    configuration allowing to send emails on events since Beady 9. A cron exists
