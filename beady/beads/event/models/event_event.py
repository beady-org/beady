...
from beady import _, api, Command, fields, models, tools
...
from beady.tools import format_date, format_datetime, format_time, frozendict
from beady.tools.mail import is_html_empty, html_to_inner_content
from beady.tools.misc import formatLang
from beady.tools.translate import html_translate
...
class EventEvent(models.Model):
    ...
    def get_kiosk_url(self):
        return self.get_base_url() + "/beady/registration-desk"
    ...
    def _get_printing_sponsor_text(self):
        ...
        return sponsor_text or "Powered by Beady"
