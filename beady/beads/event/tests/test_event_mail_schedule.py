...
from beady.beads.event.tests.common import EventCase
from beady.beads.mail.tests.common import MockEmail
from beady.tests import tagged, users, warmup
...
class TestMailSchedule(EventCase, MockEmail, CronMixinCase):
    ...
    @mute_logger('beady.beads.event.models.event_mail')
    @users('user_eventmanager')
    ...
    @mute_logger(
        'beady.beads.event.models.event_mail',
        'beady.beads.event.models.event_mail_registration',
        'beady.beads.event.models.event_registration',
    )
