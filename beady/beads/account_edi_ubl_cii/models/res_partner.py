...
from beady.beads.account_edi_ubl_cii.models.account_edi_common import EAS_MAPPING
from beady.beads.account.models.company import PEPPOL_DEFAULT_COUNTRIES
