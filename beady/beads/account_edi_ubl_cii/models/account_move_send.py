...
from beady import _, api, fields, models, tools, SUPERUSER_ID
from beady.tools import cleanup_xml_node
...
class AccountMoveSend(models.AbstractModel):
    ...
    def _hook_invoice_document_after_pdf_report_render(self, invoice, invoice_data):
        ...
        reader = BeadyPdfFileReader(reader_buffer, strict=False)

        # Post-process.
        writer = BeadyPdfFileWriter()
