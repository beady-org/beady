...
from beady import _, fields, models
from beady.exceptions import UserError, ValidationError

from beady.beads.payment import utils as payment_utils
from beady.beads.payment_stripe import const
from beady.beads.payment_stripe import utils as stripe_utils
    ...
    def _stripe_create_customer(self):
        ...
        customer = self.provider_id._stripe_make_request(
            'customers', payload={
                ...
                'description': f'Beady Partner: {self.partner_id.name} (id: {self.partner_id.id})',
