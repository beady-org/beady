...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/beady/action-test_new_api.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@beady.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(beady.tests.HttpCase):

    @mute_logger('beady.sql_db', 'beady.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/beady/action-test_new_api.action_categories",
