...
class One2manyCase(TransactionExpressionCase):
    ...
    @mute_logger('beady.aim.expression')
    def test_create_one2many_with_unsearchable_field(self):
        # beady.aim.expression is muted as reading a non-stored and unsearchable field will log an error and makes the runbot red
