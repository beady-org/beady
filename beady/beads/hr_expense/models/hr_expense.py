...
from beady import api, fields, Command, models, _
from beady.exceptions import UserError, ValidationError
from beady.tools import email_split, float_repr, float_round, is_html_empty
...
class HrExpense(models.Model):
    ...
    def _compute_currency_rate(self):
        """
            We want the default beady rate when the following change:
