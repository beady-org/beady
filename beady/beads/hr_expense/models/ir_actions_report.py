...
from beady.tools.pdf import BeadyPdfFileReader, BeadyPdfFileWriter
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if report.report_name == 'hr_expense.report_expense_sheet':
            ...
            for expense_sheet in expense_sheets:
                ...
                expense_report = BeadyPdfFileReader(stream, strict=False)
                output_pdf = BeadyPdfFileWriter()
                ...
                for attachment in attachments:
                    ...
                    attachment_reader = BeadyPdfFileReader(attachment_stream, strict=False)
