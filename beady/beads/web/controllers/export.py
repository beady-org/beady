...
from beady.http import content_disposition, request
from beady.tools import lazy_property, osutil
from beady.tools.misc import xlsxwriter
...
class ExportFormat(object):
    ...
    def from_data(self, fields, columns_headers, rows):
        """ Conversion method from Beady's export data to whatever the
