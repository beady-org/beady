...
import beady
from beady import api, models, fields
from beady.http import request, DEFAULT_MAX_CONTENT_LENGTH
from beady.tools import ormcache, config
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = beady.service.common.exp_version()
        ...
        mods = beady.conf.server_wide_modules or []
        if request.db:
        ...
        session_info = {
            ...
            "support_url": "https://www.beady.org/buy",
            "name": user.name,
            "username": user.login,
