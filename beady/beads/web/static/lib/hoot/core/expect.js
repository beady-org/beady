 ...
 * }} ExpectOptions
 *
 * @typedef {import("@beady/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@beady/hoot-dom").FormatXmlOptions} FormatXmlOptions
 * @typedef {import("@beady/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@beady/hoot-dom").QueryTextOptions} QueryTextOptions
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/beady/i);
     */
