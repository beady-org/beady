...
/**
 * @typedef {Parameters<typeof import("@beady/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@beady/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@beady/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@beady/owl").Component} target
 */
