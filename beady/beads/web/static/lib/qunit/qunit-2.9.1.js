...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("BeadyBeforeTestHook", "BeadyAfterTestHook"); // Beady customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("BeadyBeforeTestHook"); // Beady customization
