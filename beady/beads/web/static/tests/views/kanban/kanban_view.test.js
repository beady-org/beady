import { after, beforeEach, expect, test } from "@beady/hoot";
import {
    click,
    dblclick,
    drag,
...
import { Deferred, advanceFrame, animationFrame, runAllTimers, tick } from "@beady/hoot-mock";
import { Component, onRendered, onWillRender, xml } from "@beady/owl";
import {
    MockServer,
    clickKanbanLoadMore,
    clickModalButton,
...
test("quick create record: cancel when modal is opened", async () => {
    ...
    // Check beady/beady#61981 for more details.
