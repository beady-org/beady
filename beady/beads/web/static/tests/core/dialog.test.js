import { destroy, expect, test } from "@beady/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@beady/hoot-dom";
import { animationFrame } from "@beady/hoot-mock";
import { Component, onMounted, useState, xml } from "@beady/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
