import { before, destroy, expect, getFixture, test } from "@beady/hoot";
import { manuallyDispatchProgrammaticEvent, queryOne, scroll } from "@beady/hoot-dom";
import { Deferred, animationFrame } from "@beady/hoot-mock";
import { Component, xml, useRef, onMounted } from "@beady/owl";
