...
import { mockFetch } from "@beady/hoot-mock";
...
test("PWA installation process", async () => {
    ...
    expect(pwaService.canPromptToInstall).toBe(false);
    expect.verifySteps(['{"/beady":"accepted"}', "onDone call with installation accepted"]);
});
