import { destroy, expect, getFixture, onError, test } from "@beady/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@beady/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@beady/hoot-mock";
import { Component, useRef, useState, xml } from "@beady/owl";
import {
    contains,
    getService,
    makeMockEnv,
