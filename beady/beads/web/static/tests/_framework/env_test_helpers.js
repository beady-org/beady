import { after, afterEach, beforeEach, registerDebugInfo } from "@beady/hoot";
 ...
 *
 * @param {Partial<BeadyEnv>} [partialEnv]
 */
 ...
 *  (env: BeadyEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
