import { after, expect, getFixture } from "@beady/hoot";
import { click, formatXml, queryAll, queryAllTexts } from "@beady/hoot-dom";
import { animationFrame, Deferred, tick } from "@beady/hoot-mock";
import { Component, onMounted, useSubEnv, xml } from "@beady/owl";
