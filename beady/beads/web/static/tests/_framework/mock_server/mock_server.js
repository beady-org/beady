import { before, createJobScopedGetter, expect, getCurrent, registerDebugInfo } from "@beady/hoot";
import { mockFetch, mockWebSocket } from "@beady/hoot-mock";
...
export class MockServer {
    ...
    /** @type {import("@beady/hoot-mock").ServerWebSocket[]} */
    websockets = [];
    ...
    _findAction(id) {
        ...
        if (!actions.length) {
            throw makeServerError({
                errorName: "beady.beads.web.controllers.action.MissingActionError",
