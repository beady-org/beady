import { after, destroy, getFixture } from "@beady/hoot";
import { queryFirst, queryOne } from "@beady/hoot-dom";
import { App, Component, xml } from "@beady/owl";
...
/**
 * @typedef {import("@beady/owl").Component} Component
 *
 * @typedef {import("@web/env").BeadyEnv} BeadyEnv
 *
 * @typedef {Parameters<typeof import("@beady/owl").mount>[2]} MountOptions
 *
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@beady/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
