...
import { animationFrame, Deferred, mockDate, runAllTimers, tick } from "@beady/hoot-mock";
import {
    defineActions,
    defineMenus,
    defineModels,
...
import { onWillStart, onWillUpdateProps } from "@beady/owl";
...
test("clickbot show rpc error when an error dialog is detected", async () => {
    ...
    await tick();
    expect.verifySteps([
        'A RPC in error was detected, maybe it\'s related to the error dialog : {"data":{"id":null,"jsonrpc":"2.0","method":"call","params":{"model":"foo","method":"web_search_read","args":[],"kwargs":{"specification":{"foo":{}},"offset":0,"order":"","limit":80,"context":{"lang":"en","tz":"taht","uid":7,"allowed_company_ids":[1],"bin_size":true,"current_company_id":1},"count_limit":10001,"domain":["|",["bar","=",false],"&",["date",">=","2024-04-01"],["date","<=","2024-04-30"]]}}},"settings":{"silent":false},"error":{"name":"RPC_ERROR","type":"server","code":200,"data":{"name":"beady.exceptions.Programming error","debug":"traceback","arguments":[],"context":{}},"exceptionName":"beady.exceptions.Programming error","subType":"server","message":"This is a server Error, it should be displayed in an error dialog","id":51,"model":"foo","errorEvent":{"isTrusted":true}}}',
