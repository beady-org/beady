...
import { queryAll, queryAllTexts } from "@beady/hoot-dom";
import { animationFrame, Deferred } from "@beady/hoot-mock";
import { Component, onWillStart, xml } from "@beady/owl";
import {
    contains,
    defineActions,
    defineModels,
...
test("execute a new action while loading a lazy-loaded controller", async () => {
    redirect("/beady/action-4/2?cids=1");
