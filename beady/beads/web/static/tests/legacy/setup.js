/** @beady-module alias=@web/../tests/setup default=false */
...
import { App, EventBus, whenReady } from "@beady/owl";
...
function makeMockLocation() {
    return Object.assign(document.createElement("a"), {
        href: window.location.origin + "/beady",
        assign(url) {
            this.href = url;
        },
        reload() {},
