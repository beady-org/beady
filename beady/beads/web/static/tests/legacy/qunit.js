/** @beady-module alias=@web/../tests/qunit default=false */
...
import { Component, whenReady } from "@beady/owl";
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await beady.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (beady.debug && beady.debug.includes("assets")) {
    ...
    QUnit.on("BeadyAfterTestHook", (info) => {
