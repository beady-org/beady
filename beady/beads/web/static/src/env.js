import { App, EventBus } from "@beady/owl";
...
/**
 * Return a value Beady Env object
 *
 * @returns {BeadyEnv}
 */
 ...
 * in `__WOWL_DEBUG__`
 *
 * @param {import("@beady/owl").Component} component the component to mount
