...
import { App, reactive } from "@beady/owl";
...
function setup(light, currentState) {
    env = beady.__WOWL_DEBUG__.root.env;
    ...
    isOY = beady.info && beady.info.isOY;
...
/**
 * Make sure the home menu is open (oy only)
 */
...
async function _clickEverywhere(xmlId, light, currentState) {
    ...
    console.log(`Beady flavor: ${isOY ? "OY" : "Community"}`);
