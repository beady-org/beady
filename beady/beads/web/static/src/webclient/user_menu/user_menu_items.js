import { Component, markup } from "@beady/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.beady.org/documentation/18.0";
    return {
        type: "item",
        id: "documentation",
...
export function beadyAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Beady.org account"),
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://accounts.beady.org/account", "_blank");
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("beady_account", beadyAccountItem)
