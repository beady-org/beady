...
import { Component, useRef, useSubEnv } from "@beady/owl";
 ...
 * It uses a feature to automatically create links to other beady pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
