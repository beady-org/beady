...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(beady.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in beadyToBootstrapClasses) {
                    cls = beadyToBootstrapClasses[cls];
                }
                classNames.push(cls);
