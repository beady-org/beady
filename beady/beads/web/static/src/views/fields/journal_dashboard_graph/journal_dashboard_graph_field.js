...
import { Component, onWillStart, useEffect, useRef } from "@beady/owl";
...
export class JournalDashboardGraphField extends Component {
    ...
    getLineChartConfig() {
        ...
        const color10 = getColor(3, cookie.get("color_scheme"), "beady");
    ...
    getBarChartConfig() {
        ...
        const color13 = getColor(2, cookie.get("color_scheme"), "beady");
        const color19 = getColor(1, cookie.get("color_scheme"), "beady");
