...
from beady.tests import tagged, TransactionCase, Form
from beady.tools import mute_logger

from beady.beads.product.tests.common import ProductVariantsCommon, ProductAttributesCommon
...
class TestVariantsExclusion(ProductAttributesCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'beady.beads.product.models.product_product.ProductProduct._filter_to_unlink',
