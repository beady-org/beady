...
from beady.tools import float_compare, format_list, groupby
from beady.tools.image import is_image_size_above
from beady.tools.misc import unique
...
class ProductProduct(models.Model):
    ...
    def _unlink_or_archive(self, check_access=True):
        ...
        try:
            with self.env.cr.savepoint(), tools.mute_logger('beady.sql_db'):
                self.unlink()
        except Exception:
    ...
    def copy(self, default=None):
        ...
        returned.
        """
        # copy variant is disabled in https://github.com/beady/beady/pull/38303
