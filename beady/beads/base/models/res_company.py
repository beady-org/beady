...
from beady import api, fields, models, tools, _, Command, SUPERUSER_ID
from beady.exceptions import ValidationError, UserError
from beady.aim import expression
from beady.tools import html2plaintext, file_open, ormcache
...
class Company(models.Model):
    ...
    # performance reasons (see beads/web/controllers/main.py, Binary.company_logo)
