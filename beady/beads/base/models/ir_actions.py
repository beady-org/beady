...
import beady
from beady import api, fields, models, tools, _, Command
from beady.exceptions import MissingError, ValidationError, AccessError, UserError
from beady.tools import frozendict
from beady.tools.safe_eval import safe_eval, test_python_expr
from beady.tools.float_utils import float_compare
...
class IrActionsServer(models.Model):
    ...
    Since Beady 8.0 a button 'Create Menu Action' button is available on the
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'UserError': beady.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
