...
from beady import api, fields, models, tools, Command
from beady.exceptions import AccessError, UserError, ValidationError
from beady.aim import expression
from beady.tools import format_list, lazy_property, sql, unique, OrderedSet, SQL
from beady.tools.safe_eval import safe_eval, datetime, dateutil, time
from beady.tools.translate import _, LazyTranslate
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in beady.modules.loading.
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by Beady
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Beady many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Beady
