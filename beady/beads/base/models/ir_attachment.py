...
from beady import api, fields, models, SUPERUSER_ID, tools, _
from beady.exceptions import AccessError, ValidationError, UserError
from beady.http import Stream, root, request
from beady.tools import config, human_size, image, str2bool, consteq
from beady.tools.mimetypes import guess_mimetype, fix_filename_extension
...
class IrAttachment(models.Model):
    """Attachments are used to link binary files or url to any beady document.
