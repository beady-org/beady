...
import beady
from beady import api, http, models, tools, SUPERUSER_ID
from beady.exceptions import AccessDenied
from beady.http import request, Response, ROUTING_KEYS
from beady.modules.registry import Registry
from beady.service import security
from beady.tools.json import json_default
from beady.tools.misc import get_lang, submap
from beady.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and beady.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (beady.exceptions.AccessError, beady.exceptions.MissingError) as e:
                ...
                if isinstance(e, beady.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(beady.conf.server_wide_modules)
    ...
    def _gc_sessions(self):
        if os.getenv("BEADY_SKIP_GC_SESSIONS"):
            return
