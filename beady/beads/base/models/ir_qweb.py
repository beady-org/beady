...
QWeb is the primary templating engine used by Beady. It is an XML templating
...
<https://www.beady.org/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed beady user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` Beady method from ``res.users`` model.
...
from beady import api, models, tools
from beady.modules import registry
from beady.tools import config, safe_eval, pycompat
from beady.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from beady.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from beady.tools.json import scriptsafe
from beady.tools.lru import LRU
from beady.tools.misc import str2bool
from beady.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from beady.http import request
from beady.tools.profiler import QwebTracker
from beady.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from beady.beads.base.models.assetsbundle import AssetsBundle
from beady.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Beady 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__beadyAssetError=1"
