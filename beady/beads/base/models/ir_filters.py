...
from beady.tools.safe_eval import safe_eval, datetime
...
class IrFilters(models.Model):
    ...
    def get_filters(self, model, action_id=None, embedded_action_id=None, embedded_parent_res_id=None):
        ...
        :param action_id: optional ID of action to restrict filters to this action
            ...
            a contextual action.
        :return: list of :meth:`~aim.read`-like dicts containing the
    ...
    def _check_global_default(self, vals, matching_filters):
        ...
        :raises beady.exceptions.UserError: if there is an existing default and
