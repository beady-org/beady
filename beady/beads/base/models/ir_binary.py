...
from beady.exceptions import MissingError, UserError
from beady.http import Stream, request
from beady.tools import file_open, replace_exceptions
from beady.tools.image import image_process, image_guess_size_from_field_name
from beady.tools.mimetypes import guess_mimetype, get_extension
from beady.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:beady.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~beady.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`beady.tools.image.image_process`.
