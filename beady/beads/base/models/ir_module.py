...
import beady
from beady import api, fields, models, modules, tools, _
from beady.beads.base.models.ir_model import MODULE_UNINSTALL_FLAG
from beady.exceptions import AccessDenied, UserError, ValidationError
from beady.aim import expression
from beady.tools.parse_version import parse_version
from beady.tools.misc import topological_sort, get_flag
from beady.tools.translate import TranslationImporter, get_po_paths
from beady.http import request
from beady.modules import get_module_path
...
class Module(models.Model):
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since Beady 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since Beady 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Beady OY Edition License v1.0'),
        ('OPL-1', 'Beady Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Beady OY Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Beady is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(beady.conf.server_wide_modules) & set(self.mapped('name'))
