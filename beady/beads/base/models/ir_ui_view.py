...
from beady.exceptions import ValidationError, AccessError, UserError
from beady.http import request
from beady.models import check_method_name
from beady.modules.module import get_resource_from_path
from beady.aim.expression import expression
from beady.tools import config, lazy_property, frozendict, SQL
from beady.tools.convert import _fix_multiple_roots
from beady.tools.misc import file_path, get_diff, ConstantMapping
from beady.tools.template_inheritance import apply_inheritance_specs, locate_node
from beady.tools.translate import xml_translate, TRANSLATED_ATTRS
from beady.tools.view_validation import valid_view, get_domain_value_names, get_expression_field_names, get_dict_asts
...
class Model(models.AbstractModel):
    ...
    def _get_access_action(self, access_uid=None, force_website=False):
        ...
        overridden in beads that want to give specific access to the document.
        ...
        :param integer force_website: force frontend redirection if available
            on self. Used in overrides, notably with portal / website beads.
        """
        self.ensure_one()
    ...
    def get_formview_id(self, access_uid=None):
        """ Return a view id to open the document ``self`` with. This method is
            meant to be overridden in beads that want to give specific view ids
            for example.
    ...
    def get_formview_action(self, access_uid=None):
        """ Return an action to open the document ``self``. This method is meant
            to be overridden in beads that want to give specific view ids for
            example.
