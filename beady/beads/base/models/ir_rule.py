...
from beady.tools import config, SQL
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - beady/beads/test_access_rights/tests/test_feedback.py
        # - beady/beads/test_access_rights/tests/test_ir_rules.py
        # - beady/beads/base/tests/test_orm.py (/home/dle/src/beady/master-nochange-fp/beady/beads/base/tests/test_orm.py)
        self.env.flush_all()
        self.env.registry.clear_cache()
        return res
    ...
    def _make_access_error(self, operation, records):
        ...
        if company_related:
            ...
            if suggested_companies and len(suggested_companies) != 1:
                resolution_info += _('\n\nNote: this might be a multi-company issue. Switching company may help - in Beady, not in real life!')
