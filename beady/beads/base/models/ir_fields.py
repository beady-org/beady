...
from beady import api, Command, fields, models
from beady.tools import OrderedSet
from beady.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an beady
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`beady.aim.orm.Model.write` expects.

        :param model: :class:`beady.aim.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`beady.fields.Field`
