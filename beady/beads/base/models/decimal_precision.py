...
# compatibility for decimal_precision.get_precision(): expose the module in beads namespace
dp = sys.modules['beady.beads.base.models.decimal_precision']
beady.beads.decimal_precision = dp
sys.modules['beady.beads.decimal_precision'] = dp
sys.modules['beady.beads.decimal_precision'] = dp
