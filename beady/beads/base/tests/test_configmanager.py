...
import beady
from beady.tests import TransactionCase
from beady.tools import file_path, file_open, file_open_temporary_directory
from beady.tools.config import conf, configmanager, _get_default_datadir


IS_POSIX = 'workers' in beady.tools.config.options
ROOT_PATH = beady.tools.config.options['root_path'].removesuffix('/beady')
...
class TestConfigManager(TransactionCase):
    ...
    def setUp(self):
        ...
        self.patch(conf, 'beads_paths', beady.conf.beads_paths)
        self.patch(conf, 'server_wide_modules', beady.conf.server_wide_modules)
    ...
    def test_01_default_config(self):
        ...
        default_values = {
            ...
            'import_partial': '',
            'pidfile': '',
            'beads_path': f'{ROOT_PATH}/beady/beads,{ROOT_PATH}/beads',
            'upgrade_path': '',
    ...
    def test_02_config_file(self):
        values = {
            ...
            'reportgz': True,
            'root_path': f'{ROOT_PATH}/beady',  # blacklist for save, ignored from the config file
    ...
    def test_04_beady16_config_file(self):
        # test that loading the Beady 16.0 generated default config works
