...
from beady.beads.base.models.ir_qweb import QWebException, render
from beady.tools import misc, mute_logger
from beady.tools.json import scriptsafe as json_scriptsafe
from beady.exceptions import UserError, ValidationError, MissingError
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http:/.beady.org/od">
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/beady/sub">link</a>
                <a href="/link/beady/">link2</a>
            """
        values = {'url': 'beady', 'other': True}
        rendered = self.env['ir.qweb']._render(t.id, values)
        self.assertEqual(rendered.strip(), result.strip())
    ...
    @mute_logger('beady.beads.base.models.ir_qweb') # warning for template not found
