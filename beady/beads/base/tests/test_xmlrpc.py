...
from beady.exceptions import AccessDenied, AccessError
from beady.http import _request_stack

import beady
import beady.tools
from beady.tests import common
from beady.service import common as auth, model
from beady.tools import DotDict
...
class TestXMLRPC(common.HttpCase):
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   beady.api.model(lambda *_: collections.defaultdict(int)))
