...
from beady.tests import BaseCase, TransactionCase, tagged, BaseCase
from beady.tests.common import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when BEADY_TEST_FAILURE_RETRIES is set"""
