...
from beady.sql_db import db_connect, TestCursor
from beady.tests import common
from beady.tests.common import BaseCase, HttpCase
from beady.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = beady.api.Environment(self.cr, beady.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('beady.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:beady.sql_db:Found different un-closed cursor', msg)
