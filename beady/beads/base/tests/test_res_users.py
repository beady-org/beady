...
from beady.beads.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from beady.exceptions import UserError, ValidationError
from beady.http import _request_stack
from beady.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('beady.sql_db', 'beady.beads.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('beady.beads.base.models.res_users.request', request)
