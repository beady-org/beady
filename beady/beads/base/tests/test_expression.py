...
from beady.beads.base.tests.common import SavepointCaseWithUserDemo
from beady.tests.common import BaseCase, TransactionCase
...
class TestExpression(SavepointCaseWithUserDemo, TransactionExpressionCase):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('beady.aim.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have Beady has a parent company, you expect to find,
    ...
    def test_like_cast(self):
        ...
        with mute_logger('beady.sql_db'), self.assertRaises(psycopg2.Error):
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [Command.create({'name': 'address of Beady Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
