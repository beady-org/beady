...
from beady import api, http, SUPERUSER_ID, _
from beady.exceptions import AccessDenied
from beady.http import request, Response
from beady import registry as registry_get
from beady.tools.misc import clean_context

from beady.beads.auth_signup.controllers.main import AuthSignupHome as Home
from beady.beads.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def signin(self, **kw):
        ...
        try:
            ...
            if redirect:
                ...
                url = '/beady/action-%s' % action
            elif menu:
                url = '/beady?menu_id=%s' % menu
    ...
    def oea(self, **kw):
        """login user via Beady Account provider"""
        ...
        with registry.cursor() as cr:
            try:
                ...
                provider = env.ref('auth_oauth.provider_beady')
            except ValueError:
