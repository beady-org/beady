...
export class BeadyLineChart extends BeadyChart {
...
chartRegistry.add("beady_line", {
    match: (type) => type === "beady_line",
    createChart: (definition, sheetId, getters) => new BeadyLineChart(definition, sheetId, getters),
    getChartRuntime: createBeadyChartRuntime,
    validateChartDefinition: (validator, definition) =>
        BeadyLineChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => BeadyLineChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => BeadyLineChart.getDefinitionFromContextCreation(),
    name: _t("Line"),
});
...
function createBeadyChartRuntime(chart, getters) {
    ...
    for (const index in datasets) {
        ...
        if (chart.fillArea) {
            ...
            // use the transparency of Beady to keep consistency
