...
import { AbstractChart, CommandResult } from "@beady/o-spreadsheet";
 ...
 *
 * @typedef BeadyChartDefinitionDataSource
 * @property {MetaData} metaData
 * @property {SearchParams} searchParams
 *
 */

export class BeadyChart extends AbstractChart {
    /**
     * @param {BeadyChartDefinition} definition
    ...
    static getDefinitionFromContextCreation() {
        throw new Error("It's not possible to convert an Beady chart to a native chart");
    }

    /**
     * @returns {BeadyChartDefinitionDataSource}
     */
