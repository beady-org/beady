...
export class BeadyBarChart extends BeadyChart {
...
chartRegistry.add("beady_bar", {
    match: (type) => type === "beady_bar",
    createChart: (definition, sheetId, getters) => new BeadyBarChart(definition, sheetId, getters),
    getChartRuntime: createBeadyChartRuntime,
    validateChartDefinition: (validator, definition) =>
        BeadyBarChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => BeadyBarChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => BeadyBarChart.getDefinitionFromContextCreation(),
    name: _t("Bar"),
});
