...
class BadBeadyLinkError extends EvaluationError {
    constructor(menuId) {
        super(
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadBeadyLinkError(xmlId);
            }
            return menu;
        }
        ...
        urlRegistry
            .add("BeadyMenuIdLink", {
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadBeadyLinkError(menuId);
                    }
                    return {
                        url,
                        label: _t(label),
