...
import { NO_RECORD_AT_THIS_POSITION, BeadyPivotModel } from "./pivot_model";
import { EvaluationError, PivotRuntimeDefinition, registries, helpers } from "@beady/o-spreadsheet";
import { LOADING_ERROR } from "@spreadsheet/data_sources/data_source";
import { omit } from "@web/core/utils/objects";
import { BeadyPivotLoader } from "./beady_pivot_loader";
...
/**
 * @typedef {import("@beady/o-spreadsheet").FunctionResultObject} FunctionResultObject
 * @typedef {import("@beady/o-spreadsheet").PivotMeasure} PivotMeasure
 * @typedef {import("@beady/o-spreadsheet").PivotDomain} PivotDomain
 * @typedef {import("@beady/o-spreadsheet").PivotDimension} PivotDimension
 * @typedef {import("@beady/o-spreadsheet").PivotCoreMeasure} PivotCoreMeasure
 * @typedef {import("@spreadsheet").WebPivotModelParams} WebPivotModelParams
 * @typedef {import("@spreadsheet").BeadyPivot<BeadyPivotRuntimeDefinition>} IPivot
 * @typedef {import("@spreadsheet").BeadyFields} BeadyFields
 * @typedef {import("@spreadsheet").BeadyPivotCoreDefinition} BeadyPivotCoreDefinition
 * @typedef {import("@spreadsheet").SortedColumn} SortedColumn
 * @typedef {import("@spreadsheet").BeadyGetters} BeadyGetters
 * @typedef {import("@spreadsheet/data_sources/beady_data_provider").BeadyDataProvider} BeadyDataProvider
 */

/**
 * @implements {IPivot}
 */
export class BeadyPivot {
    /**
     *
     * @override
     * @param {Object} services Services (see DataSource)
     * @param {Object} params
     * @param {BeadyPivotCoreDefinition} params.definition
    ...
    constructor(services, { definition, getters }) {
        ...
        /** @type {BeadyPivotRuntimeDefinition | undefined} @protected */
        this.runtimeDefinition = undefined;

        /** @type {BeadyPivotModel | undefined} @protected */
        this.model = undefined;

        /** @type {BeadyGetters} @protected */
        this.getters = getters;

        /** @protected */
        this.loader = new BeadyPivotLoader(services.beadyDataProvider, this._load.bind(this));

        /** @type {BeadyFields | undefined} @protected */
        this._fields = undefined;

        /** @protected @type {BeadyDataProvider}*/
        this.beadyDataProvider = services.beadyDataProvider;
    ...
    /**
     * @param {BeadyPivotCoreDefinition} nextDefinition
     */
    onDefinitionChange(nextDefinition) {
        ...
        if (
            ...
            if (
                ...
                this.coreDefinition = nextDefinition;
                const runtimeDefinition = new BeadyPivotRuntimeDefinition(
                    this.coreDefinition,
                    this.getFields()
                );
    ...
    async createModelAndDefinition() {
        ...
        const definition = new BeadyPivotRuntimeDefinition(this.coreDefinition, this.getFields());
        const model = new BeadyPivotModel(
            { _t },
            {
            ...
            {
                orm: this.beadyDataProvider.orm,
                serverData: this.beadyDataProvider.serverData,
            }
        );
    ...
    /**
     * @param {import("@beady/o-spreadsheet").Maybe<FunctionResultObject>[]} args
     *
     * @returns {PivotDomain}
     */
...
export class BeadyPivotRuntimeDefinition extends PivotRuntimeDefinition {
    /**
     * @param {BeadyPivotCoreDefinition} definition
     * @param {BeadyFields} fields
     */
