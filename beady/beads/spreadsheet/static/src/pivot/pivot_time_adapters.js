...
import { registries, helpers, constants } from "@beady/o-spreadsheet";
...
const beadyMinuteNumberAdapter = {
    normalizeServerValue(groupBy, field, readGroupResult) {
        return Number(readGroupResult[groupBy]);
    },
    increment(normalizedValue, step) {
...
const beadySecondNumberAdapter = {
    normalizeServerValue(groupBy, field, readGroupResult) {
        return Number(readGroupResult[groupBy]);
    },
    increment(normalizedValue, step) {
...
pivotTimeAdapterRegistry.add("week", falseHandlerDecorator(beadyWeekAdapter));
pivotTimeAdapterRegistry.add("month", falseHandlerDecorator(beadyMonthAdapter));
pivotTimeAdapterRegistry.add("quarter", falseHandlerDecorator(beadyQuarterAdapter));

extendSpreadsheetAdapter("day", beadyDayAdapter);
extendSpreadsheetAdapter("year", beadyNumberDateAdapter);
extendSpreadsheetAdapter("day_of_month", beadyNumberDateAdapter);
extendSpreadsheetAdapter("day", beadyDayAdapter);
extendSpreadsheetAdapter("iso_week_number", beadyNumberDateAdapter);
extendSpreadsheetAdapter("month_number", beadyNumberDateAdapter);
extendSpreadsheetAdapter("quarter_number", beadyNumberDateAdapter);
extendSpreadsheetAdapter("day_of_week", beadyDayOfWeekAdapter);
extendSpreadsheetAdapter("hour_number", beadyHourNumberAdapter);
extendSpreadsheetAdapter("minute_number", beadyMinuteNumberAdapter);
extendSpreadsheetAdapter("second_number", beadySecondNumberAdapter);
