...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@beady/o-spreadsheet";
...
/**
 * @typedef {import("@beady/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@beady/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class BeadyPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").BeadyEnv} env
     * @param {import("@spreadsheet").BeadyPivotModelParams} params
    ...
    /**
     * Get the Beady domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
    ...
    /**
     * @param {import("@beady/o-spreadsheet").PivotDimension} dimension
