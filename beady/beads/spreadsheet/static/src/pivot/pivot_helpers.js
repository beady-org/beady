...
import { EvaluationError, helpers } from "@beady/o-spreadsheet";
 ...
 * @typedef {import("@beady/o-spreadsheet").Granularity} Granularity
 * */
 ...
 * @param {Record<string, BeadyField | undefined>} allFields
 * @param {string} groupFieldString
 * @returns {{field: BeadyField, granularity: Granularity, isPositional: boolean, dimensionWithGranularity: string}}
 */
