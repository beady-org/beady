...
migrationStepRegistry.add("beady_migration", {
    versionFrom: "16.1",
    migrate(data) {
        return migrateBeadyData(data);
    },
});

function migrateBeadyData(data) {
    const version = data.beadyVersion || 0;
    if (version < 1) {
...
export class BeadyVersion extends BeadyCorePlugin {
...
corePluginRegistry.add("beadyMigration", BeadyVersion);
