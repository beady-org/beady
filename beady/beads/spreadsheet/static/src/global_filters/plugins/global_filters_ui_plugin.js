...
export class GlobalFiltersUIPlugin extends BeadyUIPlugin {
    ...
    constructor(config) {
        ...
        this.beadyDataProvider = config.custom.beadyDataProvider;
        /**
        ...
        switch (filter.type) {
            ...
            case "relation":
                ...
                if (!this.recordsDisplayName[filter.id]) {
                    ...
                    this.beadyDataProvider.notifyWhenPromiseResolves(promise);
                    return [[{ value: "" }]];
                }
