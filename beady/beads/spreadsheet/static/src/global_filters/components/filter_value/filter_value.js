...
import { Component, onWillStart } from "@beady/owl";
import { components } from "@beady/o-spreadsheet";
...
export class FilterValue extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            try {
                const beadyDataProvider = this.props.model.config.custom.beadyDataProvider;
                await getFields(beadyDataProvider.serverData, this.filter.modelName);
                this.isValid = true;
            } catch (e) {
