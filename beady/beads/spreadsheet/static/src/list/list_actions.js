...
import { astToFormula, helpers } from "@beady/o-spreadsheet";
...
/**
 * @param {import("@beady/o-spreadsheet").CellPosition} position
...
/**
 * @param {import("@beady/o-spreadsheet").CellPosition} position
 * @param {import("@spreadsheet").BeadyGetters} getters
 * @returns {boolean}
 */
export const SEE_RECORD_LIST_VISIBLE = (position, getters) => {
    ...
    return !!(
        ...
        getFirstListFunction(cell.compiledFormula.tokens).functionName === "BEADY.LIST"
    );
};
