...
import { CellErrorType, EvaluationError } from "@beady/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

/**
 * @typedef {import("./beady_data_provider").BeadyDataProvider} BeadyDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {BeadyDataProvider} param0.beadyDataProvider
     */
    constructor({ beadyDataProvider }) {
        /** @protected */
    ...
    get _orm() {
        return this.beadyDataProvider.orm;
    }

    get serverData() {
        return this.beadyDataProvider.serverData;
    }
    ...
    async load(params) {
        if (params && params.reload) {
            this.beadyDataProvider.cancelPromise(this._loadPromise);
            this._loadPromise = undefined;
        }
        if (!this._loadPromise) {
            ...
            await this.beadyDataProvider.notifyWhenPromiseResolves(this._loadPromise);
        }
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").BeadyFields>}
 */
