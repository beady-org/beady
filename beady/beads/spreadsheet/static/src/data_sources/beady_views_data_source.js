...
/**
 * @typedef {import("@spreadsheet").BeadyField} BeadyField
 * @typedef {import("@spreadsheet").BeadyFields} BeadyFields
 */

/**
 * @typedef {Object} BeadyModelMetaData
 * @property {string} resModel
 * @property {BeadyFields} [fields]
 *
 * @typedef {Object} BeadyModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class BeadyViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {BeadyModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {BeadyModelMetaData} */
    ...
    /**
     * @returns {BeadyFields} List of fields
     */
    getFields() {
     ...
     * @returns {BeadyField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
