...
import { stores } from "@beady/o-spreadsheet";
...
/**
 * @template T
 * @typedef {import("@beady/o-spreadsheet").StoreConstructor<T>} StoreConstructor<T>
 */
 ...
 * @param  {any[]} args
 * @return {Promise<{ store: T, container: InstanceType<DependencyContainer>, model: BeadySpreadsheetModel }>}
 */
...
/**
 * @template T
 * @param {import("@beady/o-spreadsheet").Model} model
 * @param {StoreConstructor<T>} Store
 * @param  {any[]} args
 * @return {{ store: T, container: InstanceType<DependencyContainer>, model: BeadySpreadsheetModel }}
 */
