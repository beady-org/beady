...
from beady import _, api, Command, fields, models, modules, tools
        ...
        store.add(
            {
                ...
                # sudo: res.partner - exposing BeadyBot data is considered acceptable
                "beadybot": Store.one(self.env.ref("base.partner_root").sudo()),
            }
        )
