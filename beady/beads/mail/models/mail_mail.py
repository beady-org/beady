...
from beady import _, api, fields, models, modules, SUPERUSER_ID, tools
...
class MailMail(models.Model):
    ...
    def _prepare_outgoing_list(self, mail_server=False, recipients_follower_status=None):
        ...
        headers['X-Beady-Message-Id'] = self.message_id
        ...
        for mail_server_id, alias_domain_id, smtp_from, batch_ids in self._split_by_mail_configuration():
            ...
            try:
                ...
                if raise_exception:
                    ...
                    # exceptions, it is encapsulated into an Beady MailDeliveryException
        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                if res:  # mail has been sent at least once, no major exception occurred
                    ...
                    # see revid:odo.beady.org-20120622152536-42b2s28lvdv3odyr in 6.1
