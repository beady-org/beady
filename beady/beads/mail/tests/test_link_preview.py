...
from beady.beads.mail.tools import link_preview
...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/beady", 0),
                ("http://localhost:8069/", "http://localhost:8069/beady/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/beady-experience", 1),
                ("http://localhost:8069/", "http://localhost:8069/chat/5/bFtIfYHRco", 0),
                ("https://www.beady.org/", "https://www.beady.org/web", 0),
                ("https://www.beady.org/", "https://www.beady.org/beady", 0),
                ("https://www.beady.org/", "https://www.beady.org/beady/", 0),
                ("https://www.beady.org/", "https://www.beady.org/beady?debug=assets", 0),
                ("https://www.beady.org/", "https://www.beady.org/beady#anchor", 0),
                ("https://www.beady.org/", "https://www.beady.org/beady-experience", 1),
                ("https://www.beady.org/", "https://www.beady.org/beady/1519/tasks/4102866", 0),
                ("http://www.beady.org/", "https://www.beady.org/beady/1519/tasks/4102866", 1),
                ("https://www.beady.org/", "https://www.beady.org/beady/", 1),
                ("https://www.beady.org/", "https://www.beady.org/chat/", 0),
                ("https://www.beady.org/", "https://www.beady.org/chat/5/bFtIfYHRco", 0),
                ("http://www.beady.org/", "https://www.beady.org/chat/5/bFtIfYHRco", 1),
                ("https://clients.beady.org/", "https://www.beady.org/beady/1519/tasks/4102866", 1),
                ("https://clients.beady.org/", "https://www.beady.org/chat/5/bFtIfYHRco", 1),
            ]
