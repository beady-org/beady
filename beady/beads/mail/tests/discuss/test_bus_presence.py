...
from beady.tests import tagged, new_test_user
from beady.beads.bus.tests.common import WebsocketCase
from beady.beads.mail.tests.common import MailCommon
from beady.beads.bus.models.bus import channel_with_db, json_dump
...
class TestBusPresence(WebsocketCase, MailCommon):
    def _receive_presence(self, sender, recipient):
        ...
        self.subscribe(
            websocket,
            [f"beady-presence-{sender_bus_target._name}_{sender_bus_target.id}"],
