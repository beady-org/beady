...
from beady.beads.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
...
from beady.tests import HttpCase, tagged, users
from beady.tools import html_escape, mute_logger
