...
import beady
from beady.tools import file_open, mute_logger
from beady.beads.mail.tests.test_controller_common import TestControllerCommon
...
class TestAttachmentControllerCommon(TestControllerCommon):
    ...
    def _upload_attachment(self, thread_id, thread_model, route_kw):
        with mute_logger("beady.http"), file_open("beads/web/__init__.py") as file:
            res = self.url_open(
