...
from beady import _, api, fields, models, Command, tools
from beady.exceptions import UserError, ValidationError
from beady.aim import expression
from beady.tools.mail import is_html_empty, email_normalize, email_split_and_format
from beady.beads.mail.tools.parser import parse_res_ids
...
class MailComposer(models.TransientModel):
    ...
    auto_delete = fields.Boolean(
        ...
        help='This option permanently removes any track of email after it\'s been sent, including from the Technical menu in the Settings, in order to preserve storage space of your Beady database.')
    ...
    def _evaluate_res_domain(self):
        ...
        :return: an Beady domain (list of leaves) """
        self.ensure_one()
