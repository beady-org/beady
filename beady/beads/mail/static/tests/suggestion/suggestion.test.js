...
import { beforeEach, describe, test } from "@beady/hoot";
...
test("can @user in restricted (group_public_id) channels", async () => {
    ...
    const [partnerId_1, partnerId_2] = pyEnv["res.partner"].create([
        { email: "testpartner1.beady.org", name: "TestPartner1" },
        { email: "testpartner2.beady.org", name: "TestPartner2" },
    ]);
