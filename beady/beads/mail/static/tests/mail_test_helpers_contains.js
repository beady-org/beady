/** @beady-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@beady/hoot";
import { queryAll, queryFirst } from "@beady/hoot-dom";
 ...
 *  element.
 * @property {HTMLElement|BeadyEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when BeadyEnv, special key `target`. See @start
