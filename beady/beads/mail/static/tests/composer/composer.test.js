...
import { Deferred, animationFrame, tick } from "@beady/hoot-mock";
import {
    Command,
    getService,
    onRpc,
...
import { queryFirst } from "@beady/hoot-dom";
...
test("Show recipient list when there is more than 5 followers.", async () => {
    ...
    const partnerIds = pyEnv["res.partner"].create([
        { name: "test name 1", email: "test1.beady.org" },
        { name: "test name 2", email: "test2.beady.org" },
        { name: "test name 3", email: "test3.beady.org" },
        { name: "test name 4", email: "test4.beady.org" },
        { name: "test name 5", email: "test5.beady.org" },
        { name: "test name 6", email: "test6.beady.org" },
    ]);
    ...
    await contains("li", { text: "test1.beady.org" });
    await contains("li", { text: "test2.beady.org" });
    await contains("li", { text: "test3.beady.org" });
    await contains("li", { text: "test4.beady.org" });
    await contains("li", { text: "test5.beady.org" });
    await contains("li", { text: "test6.beady.org" });
...
test("Show 'No recipient found.' with 0 followers.", async () => {
    const pyEnv = await startServer();
    const partnerId = pyEnv["res.partner"].create({ name: "test name 1", email: "test1.beady.org" });
    await start();
