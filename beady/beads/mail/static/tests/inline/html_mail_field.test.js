...
import { after, before, beforeEach, expect, test } from "@beady/hoot";
import { press, queryOne } from "@beady/hoot-dom";
import {
    contains,
    defineModels,
    fields,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".beady-editor-editable").toHaveInnerHTML("<h1> first </h1>");
