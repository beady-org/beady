/** @beady-module alias=@mail/../tests/helpers/mock_server/models/res_users default=false */
    ...
    _mockResUsers__init_store_data() {
        const res = {
            Store: {
                ...
                beadybot: this._mockResPartnerMailPartnerFormat(this.beadybotId).get(this.beadybotId),
            },
        };
