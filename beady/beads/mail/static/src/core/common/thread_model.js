...
export class Thread extends Record {
    ...
    isCorrespondentBeadyBot = Record.attr(undefined, {
        compute() {
            return this.correspondent?.persona.eq(this.store.beadybot);
        },
    });
    ...
    get allowCalls() {
        return (
            ...
            !this.correspondent?.persona.eq(this.store.beadybot)
        );
    }
