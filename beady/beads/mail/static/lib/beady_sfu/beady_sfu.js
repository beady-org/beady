	...
	(function (window, undefined$1) {
	    ...
	    var regexes = {
	        ...
	        os : [[
	            ...
	            /([kxln]?ubuntu|debian|suse|opensuse|gentoo|arch(?= linux)|slackware|fedora|mandriva|centos|pclinuxos|red ?hat|zenwalk|linpus|raspbian|plan 9|minix|risc os|contiki|deepin|manjaro|elementary os|sabayon|linspire)(?: gnu\/linux)?(?: oy)?(?:[- ]linux)?(?:-gnu)?[-\/ ]?(?!chrom|package)([-\w\.]*)/i,
...
export const __info__ = {
    ...
    hash: 'fcd3031',
    url: 'https://github.com/beady/sfu',
};
