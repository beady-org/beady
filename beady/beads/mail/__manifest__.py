...
Communicate with your colleagues/customers/guest within Beady.
...
from Beady itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your Beady system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled Beady documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-Beady integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within Beady, and the
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'mail.assets_beady_sfu': [
            'mail/static/lib/beady_sfu/beady_sfu.js',
        ],
        'mail.assets_lamejs': [
        ...
        'mail.assets_public': [
            ...
            'web/static/lib/beady_ui_icons/style.css',
