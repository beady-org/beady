...
from beady.beads.partner_autocomplete.tests.common import MockIAPPartnerAutocomplete
...
class TestResCompany(common.TransactionCase, MockIAPPartnerAutocomplete):
    ...
    def test_extract_company_domain(self):
        ...
        company_1.website = "http://runbot.beady.org"
        self.assertEqual(company_1._get_company_domain(), .beady.org')
