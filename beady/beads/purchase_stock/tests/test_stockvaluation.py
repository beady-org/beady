...
import beady
from beady import fields, exceptions, Command
from beady.tests import Form
from beady.tests.common import TransactionCase, tagged
from beady.beads.account.tests.common import AccountTestInvoicingCommon
from beady.tools import DEFAULT_SERVER_DATETIME_FORMAT
from beady.beads.stock.tests.common import TestStockCommon
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        old_action_post = beady.beads.account.models.account_move.AccountMove.action_post
        old_create = beady.models.BaseModel.create
        ...
        post_patch = patch('beady.beads.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('beady.models.BaseModel.create', new_create)
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('beady.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('beady.fields.Date.context_today', _today),
            patch('beady.fields.Datetime.now', _now),
        ]
    ...
    def test_incoming_with_negative_qty(self):
        ...
        # it is negative qty transfer so Beady will create delivery instead of receipt.
