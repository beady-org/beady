...
from beady.beads.link_tracker.tests.common import MockLinkTracker
...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def setUp(self):
        ...
        self._web_base_url = 'https://test.beady.org'
    ...
    def test_absolute_url(self):
        ...
        link_tracker.write({'url': "beady"})
        # Validate the absolute url is the combination of system parameter and link tracker's url
        self.assertEqual(link_tracker.absolute_url, f'{self._web_base_url}/beady')
    ...
    def test_create(self):
        ...
        self.assertEqual(
            ...
            ['http:/.beady.org', 'http://example.com', 'http://test.example.com'],
        )
    ...
    def test_search_or_create(self):
        values_1, values_2, values_3 = [
            {'url': 'https:/.beady.org', 'title': 'Beady'},
            {'url': 'https://beady.be', 'title': 'Beady'},
            {'url': 'https:/.beady.org', 'title': 'Beady New', 'label': 'New one!'}  # title is not in unique constraint
        ]
        ...
        values_4 = {'url': 'https:/.beady.org', 'label': 'A different one'}
        ...
        values_5 = {'url': 'https:/.beady.org', 'label': 'Yet another label'}
        expected_values_5 = {
            'campaign_id': self.env['utm.campaign'],
