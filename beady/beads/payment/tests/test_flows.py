...
from beady.tests import tagged, JsonRpcException
from beady.tools import mute_logger

from beady.beads.payment.controllers.portal import PaymentPortal
...
class TestFlows(PaymentHttpCommon):
    ...
    def test_transaction_wrong_flow(self):
        ...
        with mute_logger("beady.http"), self.assertRaises(
            JsonRpcException,
            msg='beady.exceptions.UserError: The payment should either be direct, with redirection, or made by a token.',
        ):
    ...
    def test_transaction_wrong_token(self):
        ...
        with mute_logger('beady.http'), self.assertRaises(JsonRpcException, msg='beady.exceptions.ValidationError: The access token is invalid.'):
    ...
    @mute_logger('beady.beads.payment.models.payment_transaction')
