...
from beady import _, api, exceptions, fields, models
from beady.http import request
from beady.tools import DEFAULT_SERVER_DATETIME_FORMAT, safe_eval
...
class BaseAutomation(models.Model):
    ...
    def _get_filter_domain_fields(self):
        ...
        # see: https://github.com/beady/beady/pull/189772#issuecomment-2548804283
