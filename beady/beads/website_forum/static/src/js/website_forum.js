/** @beady-module **/
import { Component, useState, markup, onWillStart } from "@beady/owl";
...
publicWidget.registry.websiteForum = publicWidget.Widget.extend({
    ...
    async start() {
        ...
        var forumLogin = `${window.location.origin}/beady?redirect=${encodeURIComponent(window.location.href)}`
