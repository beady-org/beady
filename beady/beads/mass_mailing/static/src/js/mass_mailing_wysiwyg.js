...
import { closestElement } from "@web_editor/js/editor/beady-editor/src/BeadyEditor";
...
export class MassMailingWysiwyg extends Wysiwyg {
    ...
    setSnippetsMenuFolded(fold = true) {
        ...
        this.beadyEditor.toolbar = this.toolbarEl;
        this.beadyEditor.autohideToolbar = !!fold;
    ...
    async getSnippetsMenuClass() {
        ...
        const { MassMailingSnippetsMenu } = await beady.loader.modules.get('@mass_mailing/js/snippets.editor');
