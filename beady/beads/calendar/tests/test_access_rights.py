...
from beady.tests.common import TransactionCase, new_test_user
...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('beady.tests', 'beady.beads.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_beady(self):
        # set notifications to "handle in Beady" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Beady" notification setting can
