...
from beady.beads.calendar.models.calendar_attendee import Attendee
from beady.beads.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from beady.tools.misc import get_lang
from beady.tools import html2plaintext, html_sanitize, is_html_empty, single_email_re
...
class Meeting(models.Model):
    ...
    def default_get(self, fields):
        # super default_model='crm.lead' for easier use in beads
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Beady'
