...
import beady.tests
from beady.tools import html2plaintext

from beady.beads.website.tools import MockRequest
from beady.beads.website_hr_recruitment.controllers.main import WebsiteHrRecruitment

@beady.tests.tagged('post_install', '-at_install')
class TestWebsiteHrRecruitmentForm(beady.tests.HttpCase):
    def test_tour(self):
        ...
        with beady.tests.RecordCapturer(self.env['hr.applicant'], []) as capt:
