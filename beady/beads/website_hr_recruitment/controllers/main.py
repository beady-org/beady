...
from beady.tools.misc import groupby
...
class WebsiteHrRecruitment(WebsiteForm):
    ...
    def jobs_compatibility(self, country=None, department=None, office_id=None, contract_type_id=None, **kwargs):
        """
        Deprecated since Beady 16.3: those routes are kept by compatibility.
        They should not be used in Beady code anymore.
        """
        warnings.warn(
            "This route is deprecated since Beady 16.3: the jobs list is now available at /jobs or /jobs/page/XXX",
            DeprecationWarning
        )
        url_params = {
