...
from beady import _, api, fields, models, modules, tools
from beady.beads.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from beady.beads.account_peppol.tools.demo_utils import handle_demo
from beady.exceptions import UserError
from beady.tools import split_every
...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _get_proxy_urls(self):
        ...
        urls['peppol'] = {
            'prod': 'https://peppol.api.beady.org',
            'test': 'https://peppol.test.beady.org',
            'demo': 'demo',
        }
        return urls
    ...
    def _peppol_migrate_registration(self):
        """Migrates AWAY from Beady's SMP."""
        self.ensure_one()
    ...
    def _peppol_register_sender_as_receiver(self):
        ...
        # but we need the field for future in case the user decided to migrate away from Beady
