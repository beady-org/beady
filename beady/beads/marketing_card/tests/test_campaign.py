...
from beady.tests import Form, HttpCase, tagged, warmup
from beady.beads.mail.tests.common import MailCase
from beady.beads.marketing_card.controllers.marketing_card import SOCIAL_NETWORK_USER_AGENTS
...
class TestMarketingCardRender(MarketingCardCommon):
    ...
    def test_campaign(self):
        ...
        with patch('beady.beads.marketing_card.models.card_campaign.CardCampaign._get_model_selection',
