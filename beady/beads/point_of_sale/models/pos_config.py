...
from beady import api, fields, models, _, Command, tools, SUPERUSER_ID
from beady.http import request
from beady.exceptions import AccessError, ValidationError, UserError
from beady.tools import convert, SQL
...
class PosConfig(models.Model):
    ...
    sequence_id = fields.Many2one('ir.sequence', string='Order IDs Sequence', readonly=True,
        help="This sequence is automatically created by Beady but you can change it "
