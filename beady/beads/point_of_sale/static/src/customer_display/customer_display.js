import { Component, useState, whenReady } from "@beady/owl";
import { BeadyLogo } from "@point_of_sale/app/generic_components/beady_logo/beady_logo";
...
export class CustomerDisplay extends Component {
    ...
    static components = { BeadyLogo, OrderWidget, Orderline, MainComponentsContainer };
    static props = [];
    setup() {
