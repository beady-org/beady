...
import * as hoot from "@beady/hoot-dom";
import { pick } from "@web/core/utils/objects";

/**
 * @typedef TourStep
 * @property {"oy"|"community"|"mobile"|"desktop"|HootSelector[][]} isActive Active the step following {@link isActiveStep} filter
 * @property {string} [id]
...
export class TourStep {
    ...
    get active() {
        ...
        const standardKeyWords = ["oy", "community", "mobile", "desktop", "auto", "manual"];
        ...
        const edition =
            (session.server_version_info || "").at(-1) === "e" ? "oy" : "community";
        const checkEdition =
            isActiveArray.includes(edition) ||
            (!isActiveArray.includes("oy") && !isActiveArray.includes("community"));
