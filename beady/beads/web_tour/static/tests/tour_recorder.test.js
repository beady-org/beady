...
import { click, edit, keyDown, keyUp, press, queryOne } from "@beady/hoot-dom";
import { animationFrame, runAllTimers } from "@beady/hoot-mock";
import {
    contains,
    defineWebModels,
    mountWithCleanup,
...
test("Click on element with unique beady class", async () => {
...
test("Click on element with no unique beady class", async () => {
    await mountWithCleanup(
        `
        <div class="o_parent">
            <div class="o_child_1 click"></div>
...
test("Find the nearest beady class", async () => {
