...
from beady.beads.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from beady.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger("beady.beads.base.models.ir_http")
    ...
    @mute_logger('beady.beads.base.models.ir_http', 'beady.beads.sms.controllers.main', 'beady.http')
