...
from beady.beads.website_sale_autocomplete.controllers.main import AutoCompleteController
from beady.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'beady.beads.website_sale_autocomplete.controllers.main.AutoCompleteController'
