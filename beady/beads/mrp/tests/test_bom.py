...
from beady import exceptions, Command, fields
from beady.tests import Form
from beady.beads.mrp.tests.common import TestMrpCommon
from beady.tests.common import HttpCase, tagged, freeze_time
from beady.tools import float_compare, float_round, float_repr
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see beady/beads/web/controllers/main.py:1352)
...
class TestTourBoM(HttpCase):
    ...
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/beady/action-mrp.mrp_bom_form_action/{self.bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/beady/action-mrp.mrp_bom_form_action'
