...
class TestUiSession(HttpCase):
    ...
    def test_admin_survey_session(self):
        ...
        with patch('beady.beads.survey.models.survey_survey.Survey.action_open_session_manager', action_open_session_manager_mock):
            self.start_tour('/beady', 'test_survey_session_start_tour', login='admin')
        ...
        with patch('beady.beads.survey.models.survey_survey.Survey.action_open_session_manager', action_open_session_manager_mock):
            self.start_tour('/beady', 'test_survey_session_manage_tour', login='admin')
