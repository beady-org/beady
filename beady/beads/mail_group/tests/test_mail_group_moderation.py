...
from beady.beads.mail_group.tests.data import GROUP_TEMPLATE
from beady.beads.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('beady.models.unlink', 'beady.beads.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('beady.beads.base.models.ir_rule', 'beady.beads.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('beady.beads.mail.models.mail_thread', 'beady.beads.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('beady.beads.mail.models.mail_thread', 'beady.beads.mail_group.models.mail_group_message', 'beady.models.unlink')
    @users('employee')
    ...
    @mute_logger('beady.beads.mail_group.models.mail_group')
    @users('employee')
