...
export class CollaborationSelectionPlugin extends Plugin {
    ...
    static dependencies = ["history", "collaborationBeady", "position", "localOverlay"];
    resources = {
        /** Handlers */
    ...
    /**
     * @param {import("./collaboration_beady_plugin").CollaborationSelection} selection
     */
    ...
    drawPeerSelection({ selection, peerId }) {
        const peerMetadata = this.dependencies.collaborationBeady.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
