...
/**
 * @typedef { Object } CollaborationBeadyShared
 * @property { CollaborationBeadyPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationBeadyPlugin extends Plugin {
    static id = "collaborationBeady";
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    ...
                    case "ptp_disconnect":
                        ...
                        // todo: to implement
                        // this.beadyEditor.multiselectionRemove(fromPeerId);
                        break;
