...
import { click, manuallyDispatchProgrammaticEvent, press, waitFor } from "@beady/hoot-dom";
 ...
 * @param {string} html
 */
export function pasteBeadyEditorHtml(editor, html) {
    return pasteData(editor, html, "application/vnd.beady.beady-editor");
}
/**
 * @param {Node} node
 */
