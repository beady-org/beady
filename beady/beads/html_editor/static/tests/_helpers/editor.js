...
import { expect, getFixture } from "@beady/hoot";
import { queryOne } from "@beady/hoot-dom";
...
export async function setupWysiwyg(props = {}) {
    ...
    const el = /** @type {HTMLElement} **/ (
        queryOne(`${props.iframe ? ":iframe " : ""}.beady-editor-editable`)
    );
    if (content) {
...
export function insertTestHtml(innerHtml) {
    ...
    container.classList.add("beady-editor-editable");
