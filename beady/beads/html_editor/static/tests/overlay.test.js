...
import { click, hover, queryAll, queryOne, waitFor, waitForNone } from "@beady/hoot-dom";
...
test("Toolbar should not overflow scroll container", async () => {
    ...
    const editable = queryOne(".beady-editor-editable");
...
test("Table column control should always be displayed on top of the table", async () => {
    ...
    const scrollableElement = queryOne(".o_content");
    const table = queryOne(".beady-editor-editable table");
    await hover(".beady-editor-editable td");
