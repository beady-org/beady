...
from beady.beads.mail.models.mail_mail import _UNFOLLOW_REGEX
...
from beady.tools import email_normalize, mail, mute_logger, parse_contact_from_email
...
class AdvancedFollowersTest(MailCommon):
    ...
    def test_auto_subscribe_defaults(self):
        ...
        the behavior of beads like project and task where subscribing to
...
class UnfollowFromEmailTest(MailCommon, HttpCase):
    ...
    @mute_logger('beady.beads.base.models', 'beady.beads.mail.controllers.mail', 'beady.http', 'beady.models')
    ...
    @mute_logger('beady.beads.mail.controllers.mail', 'beady.models', 'beady.http')
