...
from beady.beads.mail.wizard.mail_compose_message import MailComposer
from beady.beads.test_mail.models.test_mail_models import MailTestTicket
from beady.beads.test_mail.tests.common import TestRecipients
from beady.fields import Datetime as FieldDatetime
from beady.exceptions import AccessError, UserError
from beady.tests import Form, tagged, users
from beady.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('beady.tests', 'beady.beads.mail.models.mail_mail', 'beady.models.unlink')
    ...
    @mute_logger('beady.tests', 'beady.beads.base.models.ir_rule', 'beady.beads.mail.models.mail_mail', 'beady.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('beady.models.unlink', 'beady.beads.mail.models.mail_mail', 'beady.beads.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('beady.models.unlink', 'beady.beads.mail.models.mail_mail')
