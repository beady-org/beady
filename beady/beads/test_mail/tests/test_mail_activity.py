...
from beady import fields, exceptions, tests
from beady.beads.mail.tests.common import mail_new_test_user, MailCommon
from beady.beads.test_mail.models.test_mail_models import MailTestActivity
from beady.tests import Form, HttpCase, users
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('beady.beads.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('beady.beads.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('beady.beads.mail.models.mail_activity_mixin.datetime', MockedDatetime):
