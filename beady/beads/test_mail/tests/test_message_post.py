...
from beady.beads.base.tests.test_ir_cron import CronMixinCase
from beady.beads.mail.tests.common import mail_new_test_user, MailCommon
from beady.beads.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from beady.beads.test_mail.models.test_mail_models import MailTestSimple
from beady.beads.test_mail.tests.common import TestRecipients
from beady.api import call_kw
from beady.exceptions import AccessError
from beady.tests import tagged
from beady.tools import mute_logger, formataddr
...
class TestMailNotifyAPI(TestMessagePostCommon):
    ...
    @mute_logger('beady.models.unlink')
    @users('employee')
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('beady.beads.mail.models.mail_mail', 'beady.models.unlink', 'beady.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    @mute_logger('beady.beads.mail.models.mail_mail', 'beady.models.unlink')
    @users('employee')
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. beadybot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-Beady-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('beady.beads.mail.models.mail_mail', 'beady.tests')
    ...
    @users('employee')
    @mute_logger('beady.beads.mail.models.mail_mail', 'beady.beads.mail.models.mail_message_schedule', 'beady.models.unlink')
    ...
    @mute_logger('beady.beads.mail.models.mail_mail', 'beady.beads.mail.models.mail_message_schedule')
    ...
    @mute_logger('beady.beads.base.models.ir_model', 'beady.beads.mail.models.mail_mail')
    ...
    def test_post_answer(self):
        ...
        self.assertSentEmail(
            self.user_employee.partner_id,
            [self.partner_1],
            references_content='beady-%d-mail.test.simple' % self.test_record.id,
