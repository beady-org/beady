...
from beady.tests.common import new_test_user, Like
from beady.tools import mute_logger
from beady.beads.test_http.utils import HtmlTokenizer
...
class TestHttpModels(TestHttpBase):
    ...
    def test_models5_stargate_setname_readonly(self):
        ...
        with self.assertLogs('beady.http', 'WARNING') as capture_http,\
             self.assertLogs('beady.sql_db', 'WARNING') as capture_sql_db:
