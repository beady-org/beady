...
from beady.beads.stock.tests.test_packing import TestPackingCommon
...
class TestPacking(TestPackingCommon):
    ...
    def test_multistep_delivery_tracking(self):
        ...
        with patch(
            'beady.beads.stock_delivery.models.delivery_carrier.DeliveryCarrier.fixed_send_shipping',
