...
from beady.tests import Form, HttpCase, tagged
...
class TestStockPickingTour(HttpCase):
    ...
    def _get_picking_url(self, picking_id):
        return '/beady/action-stock.action_picking_tree_incoming/%s' % (picking_id)
    ...
    def test_inventory_adjustment_apply_all(self):
        ...
        url = '/beady/stock.quant?menu_id=%s' % (menu['id'])
