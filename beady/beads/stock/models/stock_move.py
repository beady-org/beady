...
from beady import _, api, Command, fields, models
from beady.exceptions import UserError, ValidationError
from beady.aim import expression
from beady.tools.float_utils import float_compare, float_is_zero, float_round
from beady.tools.misc import clean_context, OrderedSet, groupby
...
Please change the quantity done or the rounding precision of your unit of measure.""",
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            doc.message_post(body=msg, author_id=beadybot_id, subject=msg_subject)
