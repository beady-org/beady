...
from beady.tools import float_compare, float_is_zero
from beady.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~beady.beads.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~beady.beads.stock.models.stock_rule.ProcurementGroup.Procurement`
