/** @beady-module alias=@bus/../tests/helpers/websocket_event_deferred default=false */
 ...
 * @typedef {[env: import("@web/env").BeadyEnv, notificationType: string, notificationPayload: any, options: ExpectedNotificationOptions]} ExpectedNotification
 */
