/** @beady-module alias=@bus/../tests/helpers/model_definitions_setup default=false */
...
insertRecords("res.users", [
    {
        active: false,
        display_name: "BeadyBot",
        login: "__system__",
        id: TEST_USER_IDS.beadybotUserId,
        name: "Public user",
        partner_id: TEST_USER_IDS.beadybotId,
    },
    {
