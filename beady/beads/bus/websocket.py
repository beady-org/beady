...
import beady
from beady import api, modules
from .models.bus import dispatch
from beady.http import root, Request, Response, SessionExpiredException, get_default_session
from beady.modules.registry import Registry
from beady.service import model as service_model
from beady.service.server import CommonServer
from beady.service.security import check_session
from beady.tools import config, lazy_property
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if beady.evented and hasattr(selectors, 'PollSelector')
