...
from beady import exceptions, fields, _
from beady.beads.mail.tests.common import mail_new_test_user
from beady.tests import common
...
class TestComputeRankCommon(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        patch_email = patch('beady.beads.mail.models.mail_template.MailTemplate.send_mail', _patched_send_mail)
    ...
    def test_02_update_rank_without_switch(self):
        ...
        patch_bulk = patch('beady.beads.gamification.models.res_users.Users._recompute_rank', _patched_recompute_rank)
    ...
    def test_03_test_bulk_call(self):
        ...
        patch_bulk = patch('beady.beads.gamification.models.res_users.Users._recompute_rank_bulk', _patched_check_in_bulk)
        self.startPatcher(patch_bulk)
