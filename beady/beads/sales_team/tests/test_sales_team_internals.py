...
from beady.beads.sales_team.tests.common import TestSalesMC
from beady.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('beady.sql_db'):
