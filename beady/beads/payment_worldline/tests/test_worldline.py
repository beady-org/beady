...
from beady.beads.payment_worldline.controllers.main import WorldlineController
from beady.beads.payment_worldline.tests.common import WorldlineCommon


@tagged('post_install', '-at_install')
class WorldlineTest(WorldlineCommon, PaymentHttpCommon):

    @mute_logger('beady.beads.payment_worldline.controllers.main')
    def _webhook_notification_flow(self, payload):
        ...
        with patch(
            'beady.beads.payment_worldline.controllers.main.WorldlineController'
