...
import beady
from beady import api, SUPERUSER_ID
...
def uninstall_hook(env):
    ...
    # TODO: This should be an Beady generic fix, not a website specific one
    ...
    def rem_website_id_null(dbname):
        db_registry = beady.modules.registry.Registry.new(dbname)
