...

{
    ...
    'sequence': 20,
    'summary': 'OY website builder',
    'website': 'https://www.beady.org/app/website',
    'version': '1.0',
    'depends': [
        'digest',
        'web',
    ...
    'data': [
        ...
        'views/snippets/s_mega_menu_beady_menu.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'website/static/src/libs/zoombeady/zoombeady.scss',
            'website/static/src/scss/website.scss',
            'website/static/src/scss/website_controller_page.scss',
            'website/static/src/scss/website.ui.scss',
            'website/static/src/libs/zoombeady/zoombeady.js',
        ...
        'website.assets_wysiwyg': [
            ...
            'website/static/src/js/editor/beady_editor.js',
        ],
