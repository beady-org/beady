...
from beady import api, fields, models, tools, release
from beady.beads.website.models.ir_http import sitemap_qs2dom
from beady.beads.website.tools import similarity_score, text_from_html, get_base_domain
from beady.beads.portal.controllers.portal import pager
from beady.beads.iap.tools import iap_tools
from beady.exceptions import AccessError, UserError, ValidationError
from beady.http import request
from beady.modules.module import get_manifest
from beady.aim.expression import AND, OR, FALSE_DOMAIN
from beady.tools import SQL, Query, sql as sqltools
from beady.tools.translate import _, xml_translate
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.beady.org'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.beady.org'
...
class Website(models.Model):
        ...
        for model_name, field_name in html_fields:
            ...
            if dependency_records:
                ...
                dependencies[model_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/beady/{model_name}/{rec.id}',
    ...
    def get_website_page_ids(self):
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Beady framework works.
    ...
    def get_client_action_url(self, url, mode_edit=False):
        ...
        return "/beady/action-website.website_preview?" + urls.url_encode(action_params)
