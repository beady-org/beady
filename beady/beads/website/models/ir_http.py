...
from beady.aim.expression import FALSE_DOMAIN
from beady.beads.base.models.ir_http import EXTENSION_TO_WEB_MIMETYPES
from beady.beads.http_routing.models import ir_http
...
def get_request_website():
    ...
    ```
    from beady.beads.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(beady.conf.server_wide_modules)
