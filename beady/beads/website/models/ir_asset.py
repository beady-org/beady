...
class IrAsset(models.Model):
    ...
    def _get_active_beads_list(self, website_id=None, **params):
        """Overridden to discard inactive themes."""
        beads_list = super()._get_active_beads_list(**params)
        ...
        return [name for name in beads_list if name not in to_remove]
