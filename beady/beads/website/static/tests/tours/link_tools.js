...
import { boundariesIn, setSelection, nodeSize } from '@web_editor/js/editor/beady-editor/src/utils/utils';
...
registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL.beady.org",
    ...
    clickOnImgStep,
    {
        ...
        trigger: ':iframe #wrap .s_text_image a[href="http:/.beady.org"]:contains(.beady.org")',
        run() {
    ...
    },
    {
        ...
        trigger: ':iframe .popover:contains("http:/.beady.org") a .fa-chain-broken',
        run: 'click',
    },
    {
        content: "Check that the link was removed",
        trigger: ':iframe #wrap .s_text_image p:contains("Go to beady:"):not(:has(a))',
    },
    // Recreate the link.
    {
    ...
    {
        content: "Click on the newly created link",
        trigger: ':iframe .s_text_image a[href="http:/.beady.org"]:contains(.beady.org")',
        run: "click",
    },
    {
        content: "Change content (editing the label input) to beady website_2",
        trigger: '#o_link_dialog_label_input:value.beady.org)',
        run: 'edit beady website_2',
    },
    {
        content: "Change content (editing the DOM) to beady website",
        trigger: ':iframe .s_text_image a[href="http:/.beady.org"]:contains("beady website_2")',
        run: 'editor beady website',
    },
    clickOnImgStep,
    {
        content: "Click again on the link",
        trigger: ':iframe .s_text_image a[href="http:/.beady.org"]:contains("beady website")',
        run: "click",
    },
    {
        content: "Check that the label input contains the new content",
        trigger: '#o_link_dialog_label_input:value(beady website)',
    },
    {
    ...
    ...clickOnEditAndWaitEditMode(),
    {
        content: "The new link content should be beady website and url beady.be",
        trigger: ':iframe .s_text_image a[href="http://beady.be"]:contains("beady website")',
        run: "click",
    },
    {
        content: "The new link content should be beady website and url beady.be",
    ...
    ...clickOnSave(),
    {
        ...
        trigger: ':iframe .s_text_image a.btn.btn-secondary[href="http://beady.be"]:contains("beady website")',
    },
    // 4. Add link on image.
    ...clickOnEditAndWaitEditMode(),
    ...insertSnippet({
    ...
    },
    {
        ...
        // TODO: remove && click
        run: "edit.beady.org && click(we-title:contains(Your URL))",
    },
    {
    ...
    },
    {
        ...
        trigger: ':iframe .popover div a:contains("http:/.beady.org")',
    },
    ...clickOnSave(),
    {
    ...
    clickOnElement("card's text", ":iframe header .s_mega_menu_cards span"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "edit https://www.beady.org",
    },
    {
        content: "Check nothing is lost",
        trigger: ":iframe header .s_mega_menu_cards a[href='https://www.beady.org']:has(img):has(h4):has(span)",
    },
    ...
    },
    {
        ...
        trigger: ':iframe #wrap .s_text_image p',
        run: "editor.beady.org",
    },
    {
        content: "Select text",
        trigger: ':iframe #wrap .s_text_image p:contains.beady.org)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: ":iframe .s_text_image p a[href='http:/.beady.org']:contains(.beady.org')",
    },
    {
        content: "Click on link to open the link tools",
        trigger: ":iframe .s_text_image p a[href='http:/.beady.org']",
        run: "click",
    },
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("https:/.beady.org")
            // To see what happens with edit, add `pause:true` to the previous step
            // and type yourself https:/.beady.org in #o_link_dialog_url_input
            // The label will be ohttps://
            this.anchor.value = "https:/.beady.org";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
        content: "Check that link was updated",
        trigger: ":iframe .s_text_image p a[href='https:/.beady.org']:contains(.beady.org')",
    },
    {
    ...
    },
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("http:/.beady.org")
            this.anchor.value = "http:/.beady.org";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
    ...
    // TODO this step which was added by https://github.com/beady.beady.orgmit/9fc283b514d420fdfd66123845d9ec3563572692
