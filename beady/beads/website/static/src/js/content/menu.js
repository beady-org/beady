...
const BaseAnimatedHeader = animations.Animation.extend({
    ...
    start: function () {
        ...
        // transitionstart, so we listen to a custom beady event.
        this._transitionCount = 0;
        this.$el.on('beady-transitionstart.BaseAnimatedHeader', () => {
    ...
    _adaptToHeaderChange: function () {
        this.options.wysiwyg && this.options.wysiwyg.beadyEditor.observerUnactive();
        ...
        this.options.wysiwyg && this.options.wysiwyg.beadyEditor.observerActive();
    },
    /**
     * @private
    ...
    _updateHeaderOnScroll: function (scroll) {
        ...
        if (this.headerIsScrolled !== headerIsScrolled) {
            ...
            if (!this.scrollHeightTooShort) {
                ...
                this.$el.trigger('beady-transitionstart');
...
publicWidget.registry.StandardAffixedHeader = BaseAnimatedHeader.extend({
     ...
     */
    destroy() {
        this.options.wysiwyg?.beadyEditor.observerUnactive("destroyStandardHeader");
        this.$el.css('transform', '');
        this.el.classList.remove("o_transformed_not_affixed");
        this.options.wysiwyg?.beadyEditor.observerActive("destroyStandardHeader");
        this._super(...arguments);
    },
    ...
    _updateHeaderOnScroll: function (scroll) {
        ...
        this.options.wysiwyg?.beadyEditor.observerUnactive("updateHeaderOnScroll");
        ...
        this.options.wysiwyg?.beadyEditor.observerActive("updateHeaderOnScroll");
    },
});
...
publicWidget.registry.MegaMenuDropdown = publicWidget.Widget.extend({
    ...
    _moveMegaMenu(megaMenuToggleEl) {
        ...
        this.options.wysiwyg?.beadyEditor.observerUnactive("moveMegaMenu");
        ...
        this.options.wysiwyg?.beadyEditor.observerActive("moveMegaMenu");
    },
...
publicWidget.registry.HeaderGeneral = publicWidget.Widget.extend({
     ...
     */
    _onCollapseShow() {
        this.options.wysiwyg?.beadyEditor.observerUnactive("addCollapseClass");
        this.el.classList.add('o_top_menu_collapse_shown');
        this.options.wysiwyg?.beadyEditor.observerActive("addCollapseClass");
    },
    /**
     * @private
     */
    _onCollapseHidden() {
        this.options.wysiwyg?.beadyEditor.observerUnactive("removeCollapseClass");
        ...
        this.options.wysiwyg?.beadyEditor.observerActive("removeCollapseClass");
    },
});
