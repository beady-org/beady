 ...
 * corner to provide the authenticated user an access to his beady backend.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!window.frameElement) {
        ...
        // - Having an event that's fire only when the page is from Beady avoids
        //   weird behaviours. (e.g. if we want to clear out the iframe, it might
        //   fire an DOMContentLoaded on a non beady page)
        window.frameElement.dispatchEvent(new CustomEvent('BeadyFrameContentLoaded'));
    }
});
