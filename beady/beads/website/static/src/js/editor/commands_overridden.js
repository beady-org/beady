...
import { UNMERGEABLE_SELECTORS } from "@web_editor/js/editor/beady-editor/src/utils/sanitize";
 ...
 */
HTMLElement.prototype.oDeleteBackwardBeadyEditor = HTMLElement.prototype.oDeleteBackward;
HTMLElement.prototype.oDeleteBackward = function (offset, alreadyMoved = false, offsetLimit) {
    ...
    this.oDeleteBackwardBeadyEditor(...arguments);
};
