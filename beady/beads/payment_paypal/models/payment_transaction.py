...
from beady.beads.payment_paypal import utils as paypal_utils
from beady.beads.payment_paypal.const import PAYMENT_STATUS_MAPPING
...
class PaymentTransaction(models.Model):
    ...
    # this field has no use in Beady except for debugging
