...
from beady.beads.calendar.controllers.main import CalendarController
from beady.beads.google_account.models.google_service import _get_client_secret
...
class GoogleCalendarController(CalendarController):
    ...
    def google_calendar_sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize Beady
            ...
            The dictionary may contains an url, to allow Beady Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted Beady to access his calendar !
