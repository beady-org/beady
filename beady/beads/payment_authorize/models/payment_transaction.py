...
from beady import _, models
from beady.exceptions import UserError, ValidationError

from beady.beads.payment import utils as payment_utils
from beady.beads.payment_authorize.models.authorize_request import AuthorizeAPI
from beady.beads.payment_authorize.const import PAYMENT_METHODS_MAPPING, TRANSACTION_STATUS_MAPPING
...
class PaymentTransaction(models.Model):
    ...
    def _send_refund_request(self, amount_to_refund=None):
        ...
        if tx_status in TRANSACTION_STATUS_MAPPING['voided']:
            ...
            # create a refund tx on Beady to reflect the move of the funds.
