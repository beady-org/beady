...
from beady.tools import DEFAULT_SERVER_DATETIME_FORMAT, mute_logger
from beady.exceptions import ValidationError, UserError
from beady.beads.base.models.res_partner import WARNING_MESSAGE, WARNING_HELP
from beady.tools import SQL, unique
from beady.beads.base_vat.models.res_partner import _ref_vat
...
class ResPartner(models.Model):
    ...
    def _increase_rank(self, field, n=1):
        if self.ids and field in ['customer_rank', 'supplier_rank']:
            try:
                with self.env.cr.savepoint(flush=False), mute_logger('beady.sql_db'):
