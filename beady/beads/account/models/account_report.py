...
from beady import models, fields, api, _, aim, Command
...
class AccountReportExpression(models.Model):
    ...
    def _expand_aggregations(self):
        ...
        while to_expand:
            ...
            if domains:
                sub_expressions |= self.env['account.report.expression'].search(aim.expression.OR(domains))
    ...
    def _get_matching_tags(self, sign=None):
        ...
        return self.env['account.account.tag'].with_context(active_test=False, lang='en_US').search(aim.expression.OR(or_domains))
