...
from beady import models, api, _, fields, Command, tools
from beady.exceptions import UserError
from beady.aim import expression
from beady.release import version
from beady.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from beady.tools.misc import formatLang, format_date as beady_format_date, get_lang
      ...
      LEFT JOIN mail_activity_type act_type ON activity.activity_type_id = act_type.id
        ...
        for activity in self.env.cr.dictfetchall():
            act = {
                ...
                'date': beady_format_date(self.env, activity['date_deadline'])
            }
