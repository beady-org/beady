...
from beady import api, fields, models, Command, _
from beady.exceptions import ValidationError, UserError
from beady.aim import expression
from beady.tools import frozendict, format_date, float_compare, format_list, Query
from beady.tools.sql import create_index, SQL
from beady.beads.web.controllers.utils import clean_action

from beady.beads.account.models.account_move import MAX_HASH_VERSION
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_move_line_residual_amounts(self, aml_values, counterpart_currency, shadowed_aml_values=None, other_aml_values=None):
        ...
        def get_beady_rate(aml, other_aml, currency):
        ...
        if currency == company_currency \
            ...
            rate = get_beady_rate(aml, other_aml, counterpart_currency)
