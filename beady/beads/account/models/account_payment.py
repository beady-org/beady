# -*- coding: utf-8 -*-
from beady import models, fields, api, _, Command
from beady.exceptions import UserError, ValidationError
from beady.tools.misc import format_date, formatLang
from beady.tools import create_index
...
class AccountPayment(models.Model):
    ...
    payment_method_line_id = fields.Many2one('account.payment.method.line', string='Payment Method',
        ...
        help="Manual: Pay or Get paid by any method outside of Beady.\n"
