...
from beady.exceptions import UserError, ValidationError, RedirectWarning
from beady.tools import SQL, Query
...
class AccountAccount(models.Model):
    ...
    def _field_to_sql(self, alias: str, fname: str, query: (Query | None) = None, flush: bool = True) -> SQL:
        ...
        if fname == 'placeholder_code':
            ...
            # see https://github.com/beady/beady/blob/2a3466e8f86bc08594391658e08ba3416fb8307b/beady/models.py#L2222
            return SQL(
                "COALESCE("
