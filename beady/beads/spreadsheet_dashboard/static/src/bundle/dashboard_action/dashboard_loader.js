...
export class DashboardLoader {
    ...
    _createSpreadsheetModel(snapshot, revisions = [], currency) {
        const beadyDataProvider = new BeadyDataProvider(this.env);
        const model = new Model(
            snapshot,
            {
                custom: { env: this.env, orm: this.orm, beadyDataProvider },
                mode: "dashboard",
        ...
        beadyDataProvider.addEventListener("data-source-updated", () =>
