...
from beady.beads.payment_asiapay.controllers.main import AsiaPayController
from beady.beads.payment_asiapay.tests.common import AsiaPayCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(AsiaPayCommon, PaymentHttpCommon):

    @mute_logger('beady.beads.payment_asiapay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'beady.beads.payment_asiapay.controllers.main.AsiaPayController.'
