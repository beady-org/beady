...
from beady.beads.payment_xendit.tests.common import XenditCommon
...
class TestPaymentTransaction(PaymentHttpCommon, XenditCommon):
    ...
    def test_no_item_missing_from_rendering_values(self):
        ...
        with patch(
            'beady.beads.payment_xendit.models.payment_provider.PaymentProvider'
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        tx = self._create_transaction('redirect')
        with patch(
            'beady.beads.payment_xendit.models.payment_transaction.PaymentTransaction'
    ...
    @mute_logger('beady.beads.payment_xendit.controllers.main')
