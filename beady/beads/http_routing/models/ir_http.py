...
import beady
from beady import api, models, exceptions, tools, http
from beady.beads.base.models import ir_http
from beady.beads.base.models.ir_http import RequestUID
from beady.beads.base.models.ir_qweb import keep_query, QWebException
from beady.beads.base.models.res_lang import LangData
from beady.exceptions import AccessError, MissingError
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        if request.is_frontend_multilang:
            ...
            if request.httprequest.method in ('GET', 'HEAD'):
                ...
                except beady.exceptions.MissingError:
