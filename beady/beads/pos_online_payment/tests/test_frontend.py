...
from beady import Command, fields
...
from beady.beads.pos_online_payment.tests.online_payment_common import OnlinePaymentCommon
from beady.beads.account.models.account_payment_method import AccountPaymentMethod
from beady.aim.expression import AND
from beady.beads.point_of_sale.tests.common import archive_products
...
class TestUi(AccountTestInvoicingCommon, OnlinePaymentCommon):
    ...
    def setUpClass(cls):
        ...
        # Code from beads/account_payment/tests/common.py:
        ...
        # End of code from beads/account_payment/tests/common.py

        # Code inspired by beads/point_of_sale/tests/common.py:
        ...
        # End of code inspired by beads/point_of_sale/tests/common.py
        ...
        # Code from beads/point_of_sale/tests/test_frontend.py:
        ...
        # End of code from beads/point_of_sale/tests/test_frontend.py
    ...
    # Code from beads/point_of_sale/tests/test_point_of_sale_flow.py
    ...
    # End of code from beads/point_of_sale/tests/test_point_of_sale_flow.py
    ...
    def test_invalid_access_token(self):
        ...
        with mute_logger('beady.http'): # Mutes "The provided order or access token is invalid." online payment portal error.
