...
from beady import api, Command, fields, models, tools
from beady.beads.base.models.res_partner import _tz_get
from beady.beads.resource.models.utils import float_to_time, HOURS_PER_DAY
from beady.exceptions import AccessError, UserError, ValidationError
from beady.tools.float_utils import float_round, float_compare
from beady.tools.misc import format_date
        ...
        for holiday in holidays:
            if not self._context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from BeadyBot (sudo)
