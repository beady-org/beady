...
from beady import _, fields, models, service
from beady.exceptions import ValidationError

from beady.beads.payment_mollie import const
...
class PaymentProvider(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        beady_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'Beady/{beady_version} MollieNativeBeady/{module_version}',
        }
