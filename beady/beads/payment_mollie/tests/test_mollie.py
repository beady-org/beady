...
from beady.beads.payment_mollie.controllers.main import MollieController
from beady.beads.payment_mollie.tests.common import MollieCommon
...
class MollieTest(MollieCommon, PaymentHttpCommon):
    ...
    @mute_logger(
        'beady.beads.payment_mollie.controllers.main',
        'beady.beads.payment_mollie.models.payment_transaction',
    )
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'beady.beads.payment_mollie.models.payment_provider.PaymentProvider'
