...
from beady.beads.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from beady.tests import common, Form
from beady.exceptions import UserError
from beady.tools import mute_logger, float_compare
...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    @mute_logger('beady.tests.common.onchange')
