...
from beady.tests import Form, TransactionCase
...
class TestSaleMrpProcurement(TransactionCase):
    ...
    def test_sale_mrp(self):
        ...
        # In order to test the sale_mrp module in Beady, I start by creating a new product 'Slider Mobile'
        # I define product category Mobile Products Sellable.

        with mute_logger('beady.tests.common.onchange'):
