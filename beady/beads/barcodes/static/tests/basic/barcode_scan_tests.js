...
import { xml, Component } from "@beady/owl";
...
QUnit.test("Display notification for media device permission on barcode scanning", async () => {
    ...
    await contains(".modal-body", { text: "Unable to access cameraCould not start scanning. Beady needs your authorization first." });
