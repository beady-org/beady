...
from beady import http, tools, _, release
from beady.exceptions import UserError
from beady.http import request
from beady.tools import replace_exceptions
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/beady_ui_icons', type='http', auth='none', cors="*")
    def beady_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/beady_ui_icons/fonts/beady_ui_icons.woff2').get_response()
