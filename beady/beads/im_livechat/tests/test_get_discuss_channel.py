...
from beady.beads.im_livechat.tests.common import TestImLivechatCommon
from beady.beads.mail.tests.common import MailCommon
from beady.tests import new_test_user, tagged
...
class TestGetDiscussChannel(TestImLivechatCommon, MailCommon):
    ...
    def test_channel_get_livechat_visitor_info(self):
        ...
        with patch('beady.http.GeoIP.country_code', new_callable=PropertyMock(return_value=belgium.code)):
