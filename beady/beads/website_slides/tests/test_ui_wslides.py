...
from beady import http, tests
from beady.beads.base.tests.common import HttpCaseWithUserPortal
from beady.beads.gamification.tests.common import HttpCaseGamification
from beady.fields import Command, Datetime
...
class TestUi(TestUICommon):
    ...
    @mute_logger("beady.http", "beady.beads.base.models.ir_rule", "werkzeug")
