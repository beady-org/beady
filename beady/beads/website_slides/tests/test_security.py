...
from beady.beads.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('beady.models', 'beady.beads.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('beady.models.unlink', 'beady.beads.base.models.ir_rule', 'beady.beads.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("beady.exceptions.ValidationError", res2.text)
