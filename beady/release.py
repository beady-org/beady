...
product_name = 'Beady'
description = 'Beady Server'
long_desc = '''Beady is a complete ERP and CRM. The main features are accounting (analytic
...
nt_service_name = "beady-server-" + series.replace('~','-')
