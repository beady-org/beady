...
from beady.tools import DotDict, lazy
from beady.tools.translate import translate_sql_constraint
...
def execute_cr(cr, uid, obj, method, *args, **kw):
    ...
    result = retrying(partial(beady.api.call_kw, recs, method, args, kw), env)
...
def retrying(func, env):
    ...
    :param beady.api.Environment env: The environment where the registry
