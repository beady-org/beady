...
term representation was ['=', 'company_id.name', 'Beady']. Used in a
...
Beady will use the SQL function 'unaccent' when available for the
...
Finally, to instruct Beady to really use the unaccent function, you have to
...
import beady.modules
from beady.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from beady.tools import Query, SQL, get_lang
from beady.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return beady.modules.registry.Registry(cr.dbname).unaccent
