...
This tool provides utilities to duplicate records across models in Beady, while maintaining referential integrity,
...
from beady.tools.sql import SQL
from beady.fields import Field, Many2one
