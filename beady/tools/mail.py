...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/beady/beady/pull/119325/files#r1301064789
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~beady.tools.misc.html_escape`.
...
def generate_tracking_message_id(res_id):
    ...
    try:
        ...
        rnd = random.random()
    rndstr = ("%.15f" % rnd)[2:]
    return "<%s.%.15f-beady-%s@%s>" % (rndstr, time.time(), res_id, socket.gethostname())
...
def email_normalize(text, strict=True):
    ...
    within beady, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within beady, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications.beady.org
    * Output: "Admin" <notifications.beady.org>
    """
